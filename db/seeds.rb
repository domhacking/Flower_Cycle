...
user1 = User.create!(name: "Olivia Gibbs", email: "og@gmail.com", role:"Supplier",  password: "password1", company_name: "MrsFlorist", house_number:"2" , road_name: "Fulham Road" , postcode: "SW6 1BW", contact_number: "020 8166 3169",  website: "www.mrsflorist.com", user_image: File.open(File.join(Rails.root, "/app/assets/images/mrsflorist.jpeg")))
user2 = User.create!(name: "Stephanie Griffiths", email: "sg@gmail.com", role:"Supplier", password: "password1", house_number: "158",  road_name: "Long Ln" , postcode: "SE1 4BS", contact_number: "020 7407 1666" , website: "www.thelondonflowershop.co.uk" , company_name: "The London Flower Shop", user_image: File.open(File.join(Rails.root, "/app/assets/images/mrsflorist.jpeg")))
user3 = User.create!(name: "Ella Tons", email: "et@gmail.com", role:"Supplier", password: "password1", house_number:"60" ,  road_name: "Upper St" , postcode: "N1 0NY" , contact_number: "020 7704 6312", website: "www.angel-flowers.co.uk", company_name: "Angel Flowers", user_image: File.open(File.join(Rails.root, "/app/assets/images/angelflowers.jpeg" )))
user4 = User.create!(name: "Cheryl Finger", email: "cf@gmail.com", role:"Supplier", password: "password1", house_number: "Rossmore Court",  road_name: "Park Rd", postcode: "NW1 6XU", contact_number: "020 7724 7525" , website: "www.flowerstation.co.uk", company_name: "Flower Station", user_image: File.open(File.join(Rails.root, "/app/assets/images/flowerstation.jpeg" )))
user5 = User.create!(name: "George Biggins", email: "gbs@gmail.com", role:"Supplier", password: "password1", house_number: "60",  road_name: "Great Marlborough St", postcode: "W1B 5AH" , contact_number: "020 7573 9563" , website: "www.wildatheart.com" , company_name: "Wild at Heart", user_image: File.open(File.join(Rails.root, "/app/assets/images/wildatheartflowers.jpeg")))
user6 = User.create!(name: "Zoe Gardner", email: "zg@gmail.com", role:"Supplier", password: "password1", house_number: "4",  road_name: "Shepherd St" , postcode: "W1J 7JD" , contact_number: "020 7499 6889" , website: "www.paulthomasflowers.co.uk" , company_name: "Paul Thomas Flowers Ltd", user_image: File.open(File.join(Rails.root, "/app/assets/images/paulthomas.jpeg" )))
user7 = User.create!(name: "Henry Jones", email: "hj@gmail.com", role:"Supplier", password: "password1", house_number: "340" ,  road_name: "Norwood Road", postcode:" SE27 9BQ" , contact_number: "020 8670 3200" , website: "www.floralhalllondon.co.uk/" , company_name: "Floral Hall", user_image: File.open(File.join(Rails.root, "/app/assets/images/floralhall.jpeg" )))
user8 = User.create!(name: "Claire Legg", email: "cl@gmail.com", role:"Supplier", password: "password1", house_number: "8" ,  road_name:  "Lamb's Conduit Passage" , postcode: "WC1R 4RG" , contact_number: "020 7375 1508", website: "www.fordsfloristflower.co.uk", company_name: "Fords Florist Flower", user_image: File.open(File.join(Rails.root, "/app/assets/images/fordsfloriest.jpeg" )))
user9 = User.create!(name: "Sam Jam", email: "sj@gmail.com", role:"Supplier", password: "password1", house_number: "44",  road_name: "Victoria", postcode: "W8 5RQ" , contact_number: "07514 178746 " , website:"www.petalon.co.uk" , company_name: "Petalon Flower Delivery", user_image: File.open(File.join(Rails.root, "/app/assets/images/petalon.jpeg")))
